...
FROM customers
WHERE NOT score < 500
-- NOT excludes the rows that meet the condition.
/* ============================================================================== 
   RANGE FILTERING - BETWEEN (check if values is within a range) (boundaries are inclusive)
=============================================================================== */
...
/* ============================================================================== 
   SET FILTERING - IN (checks if a value is in a list of values) (NOT IN is just opposite of IN)
=============================================================================== */
...
/* ============================================================================== 
   PATTERN MATCHING - LIKE (search for a specific pattern in a column)
=============================================================================== */

-- % is for anything (0 1 or more characters) and _ is for a single character
